...
class SpeakerEmbeddingLDA(nn.Module):
    def __init__(self, device: str = DEFAULT_DEVICE):
        super().__init__()
        spk_model_path = "Zonos-v0.1-speaker-embedding/ResNet293_SimAM_ASP_base.pt"
        lda_spk_model_path = "Zonos-v0.1-speaker-embedding/ResNet293_SimAM_ASP_base_LDA-128.pt"
